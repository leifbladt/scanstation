package scanstation.info.bladt.scanstation.controller;

import scanstation.info.bladt.scanstation.image.Configuration;
import scanstation.info.bladt.scanstation.image.ConfigurationFactory;
import scanstation.info.bladt.scanstation.image.processing.Converter;
import scanstation.info.bladt.scanstation.model.Composition;
import scanstation.info.bladt.scanstation.model.CompositionModule;
import scanstation.info.bladt.scanstation.model.Instrument;
import scanstation.info.bladt.scanstation.image.export.PdfExporter;
import scanstation.info.bladt.scanstation.image.scan.ScanModule;
import scanstation.info.bladt.scanstation.image.scan.ScanResults;
import scanstation.info.bladt.scanstation.image.scan.ScannerFactory;
...
public class ScanController {
    ...
    private void initialize() {
        ...
        scanInstrumentChoiceBox.setItems(FXCollections.observableArrayList(Instrument.INSTRUMENTS));
        scanInstrumentChoiceBox.setValue(Instrument.INSTRUMENTS.get(0));

        editInstrumentChoiceBox.setItems(FXCollections.observableArrayList(Instrument.INSTRUMENTS));
        editInstrumentChoiceBox.setValue(Instrument.INSTRUMENTS.get(0));
