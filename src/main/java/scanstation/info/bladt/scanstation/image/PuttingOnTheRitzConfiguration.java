...
public class PuttingOnTheRitzConfiguration extends Configuration {
    ...
    public static class PuttingOnTheRitzProcessingConfiguration extends ProcessingConfiguration {
        public PuttingOnTheRitzProcessingConfiguration() {
            ...
            Instrument firstBass = new Instrument("1st Bass", scanstation.info.bladt.scanstation.model.Key.E_FLAT);
            setImageHeight(6082, firstBass);
            setImageWidth(4292, firstBass);
            setPaperEdgeWidth(new RemoveEdges.Width(70, 70, 70, 70), firstBass);

            Instrument secondBass = new Instrument("2nd Bass", scanstation.info.bladt.scanstation.model.Key.B_FLAT);
    ...
    public static class PuttingOnTheRitzExportConfiguration extends ExportConfiguration {
        private PuttingOnTheRitzExportConfiguration() {
            ...
            setScale(72 / 600f * 1.1f, new Instrument("1st Bass", scanstation.info.bladt.scanstation.model.Key.E_FLAT));
            setScale(72 / 600f * 1.1f, new Instrument("2nd Bass", scanstation.info.bladt.scanstation.model.Key.B_FLAT));
