...
import static scanstation.info.bladt.scanstation.image.processing.ProcessingConfiguration.Key.*;
...
public class ProcessingConfiguration {
    ...
    public RemoveEdges.Width getPaperEdgeWidth(Instrument instrument, Integer page) {
        return getWidthValue(PAGE_EDGE_WIDTH_KEY, instrument, page);
    }

    public void setPaperEdgeWidth(RemoveEdges.Width paperEdgeWidth) {
        setPaperEdgeWidth(paperEdgeWidth, null, null);
    }

    public void setPaperEdgeWidth(RemoveEdges.Width paperEdgeWidth, Instrument instrument) {
        setPaperEdgeWidth(paperEdgeWidth, instrument, null);
    }

    public void setPaperEdgeWidth(RemoveEdges.Width paperEdgeWidth, Instrument instrument, Integer page) {
    ...
    private RemoveEdges.Width getWidthValue(Key key, Instrument instrument, Integer page) {
        Object value = getValue(key, instrument, page);
        return (value != null) ? (RemoveEdges.Width) value : null;
    }
